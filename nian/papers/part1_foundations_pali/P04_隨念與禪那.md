...
本篇為一致於廣為流傳的「三念 *appanā*」傳統表述，仍保留念寂靜於 *appanā* 欄位備註，讀者應知此處有論疏層之微細分判。
...
本篇的核心重新框定：*upacāra* 不是「未達成的 *appanā*」，而是 *anussati* 的設計終點。
...
這個例子對漢傳念佛人有直接啟發。漢傳傳統常把「念佛三昧」理解為須深入禪定才能發起觀慧的前提條件——但從 Phussadeva 的結構看，*upacāra* 平台（心穩定、五蓋鎮伏、*pīti* 已生）就足以成為 *vipassanā* 的發起點。不需要先攀到 *appanā*。
...
- **⚠️**：心流與 *upacāra-samādhi* 的現象學相似不等於解脫論等價。目的論、對境本體、升級路徑三重差異構成不可還原的差距（non-reducible gap）。將 *anussati* 用「心流狀態」框架說明以為親切——這固然平易可親，但也要主動加上警示條文，避免誤讀。
