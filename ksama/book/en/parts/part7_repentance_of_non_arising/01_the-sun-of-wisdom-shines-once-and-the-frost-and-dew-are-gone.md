## 7.1 The Sun of Wisdom Shines Once, and the Frost and Dew Are Gone

Return to the very beginning.

This volume opened with the most concrete, most palpable scene in the whole Vinaya: a monk, before a witness, disclosing his offense word by word, daring not conceal it. "I, so-and-so, committed such-and-such an offense."

From that moment on, a question already lay hidden beneath that sentence — who is the "I" who says this? What is the "offense" that is said?

What the first six parts answered, all along, was the phenomenal face of repentance: how disclosure cleanses, how concealment compounds into grave fault, how a liturgy grows a single act into a whole assembly. Those answers were all true, all necessary. But they treated "the self that erred" and "the transgression I committed" as two given poles, attending only to the traffic of purity and defilement that runs between them; they never turned the blade of the question around, against the poles themselves.

This chapter answers that question head-on.

The answer is this: at repentance's deepest point, what happens is not the erasing of a really-existent transgression, but the seeing that "the self that erred" and "the transgression I committed" cannot, from the first, be apprehended. This is the repentance of non-arising — the emptiness of the Heart Sūtra appearing face-to-face in the gate of repentance, the one and only subtraction in the Six Practice Gates.

### The Summit of the Three Repentances: Supporting Wisdom
...
### Sit Upright and Contemplate the Real Mark; the Host of Transgressions Are Like Frost and Dew
...
All karmic obstruction has its source in "deluded thought." And since the source is deluded thought, the road of remedy is not to seek outward for some absolver to wipe the obstruction away, but to "sit upright and contemplate the real mark" — to see the real mark. Once the real mark appears, the host of transgressions are like the frost of morning, the dew of night: once the sun of wisdom rises, they melt of themselves.
...
### Transgression: Neither Within, Nor Without, Nor in Between
...
### Repentance Is the Heart Sūtra's "Emptiness"
...
Set this line into the whole of the Six Practice Gates, and its design shows itself. The six gates — mindfulness, giving, precepts, concentration, vow, repentance — each answer to one item of the Heart Sūtra: mindfulness to "seeing" (Avalokiteśvara's contemplating), giving to "crossing" (crossing beyond all suffering and distress), precepts to "no" (that string of negations — neither defiled nor pure), concentration to "the ultimate" (ultimate nirvāṇa), vow to "attainment" (attaining *anuttarā-samyak-saṃbodhi*). These five gates each carry a verb, and all are additive: to see, to cross over, to negate-and-uphold, to bring to the ultimate, to realize — every one of them is to do a thing.

Repentance alone answers to no verb, but to "emptiness" — form itself is emptiness, all dharmas marked with emptiness.

The reason repentance has no verb of its own in the Heart Sūtra is not that it is a gap; it is precisely that it *is* emptiness: emptiness is not an act, and so no verb can be matched to it.

And so the Six Practice Gates are "five additions and one subtraction": five gates build additively; the one gate of repentance empties subtractively. What the repentance of non-arising empties is exactly the grasping of the other five gates — it empties that bit of clinging to substantiality in "the I who is mindful and the Buddha who is recollected," "the I who gives and the thing that is given," "the I who keeps and the precept that is kept." It is the one subtractive gate in the whole sequence. This is also why repentance must stand within the sequence and not outside it: only with one subtractive gate, emptying away one by one the graspings the others have built up, does the whole road avoid quietly congealing upon that subtle grasping at self in "I am practicing."

And it is exactly here that the line running through the whole volume — "to receive is not to be absolved" — is raised to "emptiness is not absolution." From the very beginning, the "receiving" of disclosure was never a being-pardoned by anyone — it was one's own bearing of the burden, with no absolving officer present. Walking all this way, that line summits here: at the repentance of non-arising, even the "really-existent transgression that could be absolved" is seen to be unapprehendable from the first — and if there is no real transgression, where would an absolver come from? Emptiness is a seeing, not a remission. There is no absolution in the repentance of non-arising, because no one was ever bound.

### One Thing to See Clearly Here

The moment "transgression has no own-being" is written, the most dangerous slope lies underfoot: it is all too easy to slide from "transgression cannot be apprehended" into "transgression is a fiction, causation is of no account, do as you please."
...
Between "emptiness" and "license," then, lies the whole of the Middle Way. "Neither apprehending transgression nor non-transgression" is a double negation — neither grasping transgression as really existent, nor falling into the annihilationist view of "no transgression at all." What it negates is transgression's "own-being," not karma's "fruit." Transgression's nature is empty; karmic fruit is not empty: the dependently-arisen law that one reaps what one sows is not moved by a hair. Carrying forward the earlier salt-parable — even an ideal phenomenal repentance can only dilute and redirect the trajectory of the fruit, never erase already-made karma out of thin air — at the summit of principial repentance this line is not loosened but drawn tighter still.

Each time "transgression cannot be apprehended" is said, ask one question: does this sentence imply that karmic fruit is being swept away? If it does, it has already slipped off the Middle Way. Emptiness is the seeing that transgression has no own-being, not the annihilation of cause and effect — this is the highest point this part has to guard.
...
The fullest, most dramatic scene of this truth — that transgression has no own-being — is the story of one who broke a precept. No: of two monks who broke a precept, and of one venerable elder, foremost in upholding the Vinaya, who took the rebuke full in the face.

In the next chapter, we walk into that scene.
