...
subtitle: "Therapeutic Anxiety and Legalism"
title_zh: 兩種失模
subtitle_zh: 治療化的戒律恐懼症與律法主義
volume: 戒門 SĪLA
paper_id: SILA-P28
paper_number: P28
language: en
...
failure mode; therapeuticization; precept-anxiety; legalism; keeping the feeling, dropping the form; keeping the form, dropping the heart; *cetanā*; *saṃvara*; volition undertaken and upheld; *sīlabbata-parāmāsa*; the three fetters; regional adaptation; precept-essence; the undertaking; modern diagnosis
...
失模、治療化、戒律恐懼症、律法主義、去形留感、守形去心、思之受持並守持、戒禁取、隨方毘尼、戒體、受、現代診斷
